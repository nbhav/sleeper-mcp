...
- Use `make local-up` to prepare the local Docker workflow and `make teardown` after Docker workflow checks. Do not remove named volumes or `data/` unless explicitly asked.
